<div class="container">
    ...
    <form method="post" enctype="multipart/form-data" action="">
        <div class="form-group">
            ...
            <input type="text" name="id" value="<?php echo $product['product_id'] ?>" required class="form-control" disabled>
            ...
            <input type="number" name="price" value="<?php echo number_format($product['product_price'])?>" required class="form-control">
            ...
            <input type="text" name="description" value="<?php echo $product['product_description'] ?>" required class="form-control">
            <label for="">Category Product</label>
            <input type="text" name="category" value="<?php echo $product['product_category'] ?>" required class="form-control">
        </div>
